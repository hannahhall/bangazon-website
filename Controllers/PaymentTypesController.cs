...
namespace BangazonAuth.Controllers
{
    public class PaymentTypes : Controller
    {
        ...
        public PaymentTypes(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeId,AccountName,AccountNumber")] PaymentType paymentType)
        {
